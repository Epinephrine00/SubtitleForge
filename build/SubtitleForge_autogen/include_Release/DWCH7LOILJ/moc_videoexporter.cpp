/****************************************************************************
** Meta object code from reading C++ file 'videoexporter.h'
**
...
#include "../../../../src/video/videoexporter.h"
...
#error "The header file 'videoexporter.h' doesn't include <QObject>."
...
void VideoExporter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (VideoExporter::*)(int )>(_a, &VideoExporter::progressChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (VideoExporter::*)(bool , const QString & )>(_a, &VideoExporter::exportFinished, 1))
            return;
    }
}
...
// SIGNAL 0
void VideoExporter::progressChanged(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void VideoExporter::exportFinished(bool _t1, const QString & _t2)
{
